...
public class ExcelExporterCustomerTotalOrder {
	private XSSFWorkbook workbook;
	private XSSFSheet sheet;
	private List<ICustomerTotalOrder> customers;
	 ...
	 * @param customers
	 */
	public ExcelExporterCustomerTotalOrder(List<ICustomerTotalOrder> customers) {
	...
	private void writeDataLines() {
		...
		for (ICustomerTotalOrder user : this.customers) {
